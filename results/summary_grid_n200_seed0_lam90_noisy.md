# grid 6x10 | lambda=90 | perception=noisy (recall=0.9, fp=0.01, latency=2.0s)
...
|---|---|---|---|---|---|---|---|
| shortest_path | 87.5 [82.5, 92.0] | 0.213 [0.166, 0.265] | 22.0 / 40.8 | 13.1 | 0.8 | 0.06 | 0.242 |
| static_risk | 92.5 [88.5, 96.0] | 0.163 [0.124, 0.207] | 22.6 / 41.0 | 11.1 | 0.5 | 0.04 | 1.587 |
| dynamic_risk | 94.0 [90.5, 97.0] | 0.153 [0.117, 0.196] | 23.0 / 44.2 | 10.2 | 0.5 | 0.02 | 2.332 |
| dynamic_perfect_perception | 94.0 [90.5, 97.0] | 0.149 [0.111, 0.191] | 23.5 / 45.3 | 9.6 | 0.5 | 0.03 | 2.194 |
...
|---|---|---|---|
| static_risk | +5.0 [+2.0, +8.5] | -0.051 [-0.076, -0.023] | -0.2 [-0.5, +0.0] |
| dynamic_risk | +6.5 [+3.5, +10.0] | -0.060 [-0.086, -0.034] | -0.2 [-0.5, +0.1] |
| dynamic_perfect_perception | +6.5 [+3.5, +10.0] | -0.065 [-0.091, -0.039] | +0.3 [-0.2, +0.9] |
...
| dynamic_perfect_perception | +1.5 [+0.0, +3.5] | -0.014 [-0.025, -0.005] | +0.5 [-0.0, +1.0] |

## Hazard-relevant scenarios (81 of 200: the shortest route gets dose >= 0.05 or fails)

| Policy | Success % [95% CI] | Mean dose [95% CI] | Time s (succ.) mean / p95 | Smoke s | Fire s | Reroutes | Plan ms |
|---|---|---|---|---|---|---|---|
| shortest_path | 69.1 [58.0, 79.0] | 0.518 [0.433, 0.607] | 28.7 / 49.9 | 32.1 | 2.1 | 0.15 | 0.244 |
| static_risk | 81.5 [72.8, 88.9] | 0.379 [0.301, 0.457] | 29.1 / 45.3 | 26.6 | 1.1 | 0.10 | 1.453 |
| dynamic_risk | 85.2 [77.8, 92.6] | 0.359 [0.283, 0.437] | 30.1 / 54.2 | 24.8 | 1.1 | 0.05 | 2.493 |
| dynamic_perfect_perception | 85.2 [77.8, 92.6] | 0.350 [0.274, 0.431] | 31.5 / 60.2 | 23.4 | 1.1 | 0.07 | 2.360 |
...
| dynamic_perfect_perception | +16.0 [+8.6, +24.7] | -0.167 [-0.231, -0.108] | +1.0 [-0.8, +2.8] |
...
| dynamic_perfect_perception | +3.7 [+0.0, +8.6] | -0.028 [-0.053, -0.006] | +1.6 [+0.4, +3.1] |
